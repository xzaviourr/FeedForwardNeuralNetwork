# Feed forward neural network for prediction of release year of a song from a set of timbre-based audio features

This project is created to fulfill the requirements of CS 725 course requirements at IIT Bombay. 

## Results 
Achieved RMSE error of 10.60 in training set, and 10.87 in test set. 
